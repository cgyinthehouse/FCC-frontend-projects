  ...
  */
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-between items-center md:flex-row lg:w-[95%] mx-auto md:my-4 px-4 h-[calc(100vh-82px)] md:h-[calc(100vh-64px)] max-w-[1800px]">
        <button
          className={`${
            (!windowVisible.editor && "rotate-180 text-zinc-500") ||
            "text-zinc-300"
          } ${windowVisible.preview || 'opacity-0'} transition hover:scale-125`}
          ...
          <textarea
            className={`${windowVisible.editor ? "w-full" : "hidden"} ${
              windowVisible.preview
                ? "basis:w-1/3 md:basis-1/2 md:h-full max-h-[50vh] min-h-[250px]"
          ...
          <div
            ...
            className={`${windowVisible.preview ? "w-full" : "hidden"} ${
              windowVisible.editor
                ...
                : "md:basis-2/3 h-full"
            } font-poppins text-sm lg:text-base rounded-md border px-3 shadow-lg overflow-auto`}
          >
            <ReactMarkdown
              children={md}
        ...
        <button
          className={`${
            ...
            "text-zinc-300"
          } ${windowVisible.editor || 'opacity-0'} transition hover:scale-125`}
